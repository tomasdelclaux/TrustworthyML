# -*- coding: utf-8 -*-
""" CIS6261TML -- Homework 3 -- nets.py

# This file contains network architectures
"""
...
"""
def get_simple_classifier(flat_size =32 * 32 * 3, num_labels = 20, num_hidden = 32, verbose = False, l2_regularization_constant = 0.0):
...
"""
def get_deeper_classifier(flat_size=32*32*3, num_labels=20, num_hidden=[128, 96, 64, 32], verbose=True):
...
"""
def train_model(model, x_train, y_train, x_test, y_test, num_epochs, batch_size=64, optimalg='sgd', lossfn='categorical_crossentropy', metrics_list=['accuracy'], verbose=True):
